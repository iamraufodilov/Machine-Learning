...
if __name__ == '__main__':
    # Reading data
    d = pd.read_csv("G:/rauf/STEPBYSTEP/Projects/ML/Machine Learning/Decision Tree/data/train.csv")[['Age', 'Fare', 'Survived']].dropna()
...
# the code taken from source and implemented.